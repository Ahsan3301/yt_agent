...
/** Format a timestamp as a relative phrase ("2m ago"). */
export function formatAgo(v: unknown): string {
...
/** Format a timestamp as a localized date+time string, or '—'. */
...
/** Format a timestamp as just the time portion (HH:MM:SS). */
