...
# Flux prompt distiller MOVED to modules/providers/prompt.py.
#
# Five providers call it, so it belonged with them rather than in the
# file they were being extracted from — it was the specific thing
# blocking the generate bodies from moving out of here.
#
# Imported under the original private names so the seven call sites
# below are untouched, which keeps the move reviewable as a move.
